...
class Posts_Berita_1_Widget extends WP_Widget
{
    function __construct()
    {
        parent::__construct(
            'posts_berita_1_widget',
            __('Posts Berita 1', 'velocity'),
            array('description' => __('Menampilkan postingan template berita 1', 'velocity'),)
        );
    }
...
function register_posts_berita_1_widget()
{
    register_widget('Posts_Berita_1_Widget');
}
add_action('widgets_init', 'register_posts_berita_1_widget');
