...
/**
 * WIDGET TABS BERITA 1
 */
if (!defined('ABSPATH')) {
    exit; // Exit if accessed directly.
}

class Tabs_Berita_1_Widget extends WP_Widget
{
    function __construct()
    {
        parent::__construct(
            'tabs_berita_1_widget',
            __('Tabs Berita 1', 'velocity'),
            array('description' => __('Menampilkan tabs template berita 1', 'velocity'),)
        );
    }
...
function register_tabs_berita_1_widget()
{
    register_widget('Tabs_Berita_1_Widget');
}
add_action('widgets_init', 'register_tabs_berita_1_widget');
