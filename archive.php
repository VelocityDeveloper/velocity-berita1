            ...
            <main class="site-main col order-2 px-0" id="main">
                ...
                ?>
                    <header class="page-header block-primary">
                        <?php the_archive_title('<h6 class="bg-color-theme pt-2 pb-1 px-3 text-uppercase text-white d-inline-block mb-0">Category : ', '</h6>'); ?>
                            ...
                            <div class="row m-0">
                                ...
                                <div class="col-md-7 mt-md-0 mt-2">
                                    <div class="post-text">
                                        <?php
                                        the_title(
                                            sprintf('<h5 class="m-0"><a href="%s" rel="bookmark">', esc_url(get_permalink())),
                                            '</a></h5>'
                                        );
                                        ?>
                                        <div class="post-date text-muted py-2"><?php echo get_the_date('j F Y, H:i a'); ?></div>
